  ...
  const faqsData = [
    {
      id: '01',
      number: '01',
      question: t('What classes does Ever Green Model School offer?'),
      answer: t(
    ...
    },
    {
      id: '02',
      number: '02',
      question: t('What is the age requirement for Nursery admission?'),
      answer: t(
    ...
    },
    {
      id: '03',
      number: '03',
      question: t('When does the admission process begin?'),
      answer: t(
    ...
    },
    {
      id: '04',
      number: '04',
      question: t('Are extracurricular activities available?'),
      answer: t(
    ...
    },
    {
      id: '05',
      number: '05',
      question: t('How can parents apply for admission?'),
      answer: t(
    ...
    },
    {
      id: '06',
      number: '06',
      question: t('Does the school organize annual events?'),
      answer: t(
    ...
    },
    {
      id: '07',
      number: '07',
      question: t('How can I contact the school?'),
      answer: t(
