...
function SmartClass() {
  ...
  const smartClassParagraphs = [
    <>
      {t("At Ever Green Model School, our Smart Classrooms blend cutting-edge digital infrastructure with interactive teaching methodologies. We transform traditional learning into a vibrant, visual, and highly interactive experience for students across all grades.")}
    </>,
    <>
      {t("With high-definition Smart TVs installed in classrooms, students engage in visual animation teaching, digital storytelling, online spoken English modules, and accelerated mental math sessions that sharpen logic and problem-solving skills from an early age.")}
    </>,
  ];
  ...
  const smartClassPhotos = [
    {
      src: academicProgImg,
      caption: t('Digital Animation & Visual Concept Demonstration'),
      tag: t('Smart Screen'),
    },
    {
      src: academicProg1Img,
      caption: t('Interactive Classroom Visual Phonics Session'),
      tag: t('Phonics & Reading'),
    },
    {
      src: academicProg5Img,
      caption: t('Digital Geography & Interactive Map Learning'),
      tag: t('Interactive Maps'),
    },
    {
      src: academicProg3Img,
      caption: t('Teacher Guided Audio-Visual Concept Explanation'),
      tag: t('Visual Teaching'),
    },
    {
      src: academicProg4Img,
      caption: t('Interactive Spoken English Online Class Modules'),
      tag: t('Spoken English'),
    },
  ];
  ...
  const features = [
    {
      icon: Film,
      title: t('Video Animation Teaching'),
      description: t(
    ...
    {
      icon: Calculator,
      title: t('Quick Math Problem Solving'),
      description: t(
    ...
    {
      icon: MonitorCheck,
      title: t('Interactive E-Learning'),
      description: t(
    ...
    {
      icon: Zap,
      title: t('Engaging & Joyful Learning'),
      description: t(
  ...
  return (
    <div className="flex min-h-screen flex-col justify-between bg-[#F6FAEF]">
      <div>
        ...
        <FacilityHero
          title={t("Smart Classrooms")}
          subTagline={t("Interactive digital learning, video animation, spoken English, and quick math problem solving.")}
          aboutTitle={t("Visual & Interactive Learning Environment")}
          aboutParagraphs={smartClassParagraphs}
          image={smartClassImg}
          prevLink="/facilities/yoga"
          nextLink="/facilities/art"
          badgeText={t("Smart Education")}
        />

        {/* Image Slider Showcase */}
        <FacilitySlider
          title={t("Smart Classroom Experience in Action")}
          subtitle={t("Take a visual tour through our animated digital lessons, online spoken English, and interactive math sessions.")}
          ...
          <div className="flex flex-col items-center justify-between rounded-[36px] border-2 border-[#191A23] bg-[#1E3F20] p-8 text-white shadow-[0_8px_0_0_#191A23] md:flex-row md:p-12">
            <div className="max-w-2xl text-center md:text-left">
              <h3 className="font-fredoka text-2xl font-bold text-[#B9FF66] sm:text-3xl">
                {t("Experience Smart Learning at EGMS")}
              </h3>
              <p className="mt-2 font-poppins text-sm text-white/90 sm:text-base">
                {t("Discover how our visual animations, Smart TV modules, and interactive sessions inspire a lifelong passion for learning.")}
              </p>
            </div>
            <Link
              to="/contact"
