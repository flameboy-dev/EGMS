...
function Yoga() {
  ...
  const yogaParagraphs = [
    <>
      {t("At Ever Green Model School, physical wellness and mental tranquility go hand in hand with academic learning. We organize special Yoga and Meditation sessions every Sunday morning.")}
    </>,
    <>
      {t("Each and every Sunday, interested students can apply to join expert-guided sessions focusing on posture correction, flexibility, breathing techniques (Pranayama), memory enhancement, and stress-free mindfulness.")}
    </>,
  ];
  ...
  const yogaPhotos = [
    {
      src: healthyEnv3Img,
      caption: t('Open Air Morning Assembly & Student Physical Exercises'),
      tag: t('Morning Fitness'),
    },
    {
      src: healthyEnv1Img,
      caption: t('Serene Green Campus Lawn for Outdoor Pranayama'),
      tag: t('Green Campus'),
    },
    {
      src: healthyEnv2Img,
      caption: t('Mindfulness & Physical Balance Assembly'),
      tag: t('Mindfulness'),
    },
    {
      src: healthyEnv6Img,
      caption: t('Spacious Fresh Air Environment for Physical Balance'),
      tag: t('Holistic Health'),
    },
    {
      src: healthyEnv5Img,
      caption: t('Pranayama Breathing & Mental Focus Exercises'),
      tag: t('Breath Control'),
    },
  ];
  ...
  const yogaBenefits = [
    {
      icon: Sun,
      title: t('Sunday Special Sessions'),
      description: t(
    ...
    {
      icon: Heart,
      title: t('Pranayama & Breath Control'),
      description: t(
    ...
    {
      icon: Sparkles,
      title: t('Mindfulness & Meditation'),
      description: t(
    ...
    {
      icon: Flame,
      title: t('Open to All Interested Students'),
      description: t(
  ...
  return (
    <div className="flex min-h-screen flex-col justify-between bg-[#F6FAEF]">
      <div>
        ...
        <FacilityHero
          title={t("Yoga & Meditation (Sunday Special)")}
            ...
            <div className="flex flex-col items-start justify-between gap-6 lg:flex-row lg:items-center">
              <div className="max-w-2xl">
                <div className="inline-flex items-center gap-2 rounded-full border border-[#191A23] bg-white px-4 py-1 font-poppins text-xs font-bold text-[#1E3F20]">
                  <Sun className="h-4 w-4 text-[#1E3F20]" /> {t("Sunday Registration Open")}
                </div>
                <h2 className="mt-3 font-fredoka text-2xl font-semibold text-[#000000] sm:text-3xl md:text-4xl">
                  {t("Register for Sunday Yoga & Meditation")}
                </h2>
                <p className="mt-2 font-poppins text-sm leading-relaxed text-[#1E3F20] sm:text-base">
                  {t("Unlock the benefits of morning yoga and meditation for your child. Interested students can apply directly online!")}
                </p>
              </div>
              <button
              ...
              >
                {t("Apply for Sunday Yoga Session")}
              </button>
            </div>
          </div>
        </section>
        ...
        <FacilitySlider
          title={t("Sunday Yoga & Meditation Gallery")}
          subtitle={t("Moments of mindfulness, breathing exercises, and morning yoga routines.")}
          slides={yogaPhotos}
        />
